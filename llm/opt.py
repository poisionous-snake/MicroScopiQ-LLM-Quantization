    ...
    for i in range(len(layers)):
        ...
        for name in subset:
            ...
            gptq[name].fasterquant(
                percdamp=args.percdamp, groupsize=args.groupsize, actorder=args.act_order, static_groups=args.static_groups, prunen=args.prunen, prunem=args.prunem, plot=(i==0), vq_dim=args.vq_dim, codebook_size=args.codebook_size, row_group_size=args.vq_row_group_size
            )
...
if __name__ == '__main__':
    ...
    for dataset in datasets: 
        ...
        ########## Saving model
    # torch.save(model.state_dict(), "opt-125m.pt")
    # # model.save_pretrained('/usr/scratch/akshat/work/LLMQuant/LLMQuant/quantized/opt-125m')
    # print(torch.load('opt-125m.pt'))
